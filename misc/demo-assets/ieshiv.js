...
(function (exports) {
  ...
  var debug = window.ieShivDebug || false,
      tags = [ "ngInclude", "ngPluralize", "ngView", "ngSwitch", "accordion", "accordionGroup", "accordionHeading",
               "accordionTransclude", "alert", "btnRadio", "btnCheckbox", "carousel", "slide", "collapse",
               "dropdownToggle", "modal", "pagination", "popoverPopup", "popover", "progress", "progressbar", "tabs",
               "pane", "tooltipPopup", "tooltip", "typeahead", "typeaheadPopup"
                ];
