describe('tabs', function() {
  ...
  describe('basics', function() {
    ...
    it('should create clickable titles', function() {
      ...
      expect(tagsToLower(t.find('a').eq(1).children().html())).toBe('<b>Second</b> Tab 2');
    });
  ...
  describe('advanced tab-heading element', function() {
    ...
    it('should create a heading bound to myHtml', function() {
      expect(tagsToLower(heading().eq(0).html())).toBe("<b>hello</b>, there!");
    });
  ...
  describe('remove', function() {
    ...
    beforeEach(inject(function($compile, $rootScope) {
      scope = $rootScope.$new();
      elm = angular.element('<div>').appendTo(document.body);
      var tpl = "<tabset><tab heading='1'>Hello</tab><tab ng-repeat='i in list' heading='tab {{i}}'>content {{i}}</tab></tabset>";
      elm.html(tpl);
      $compile(elm)(scope);
      scope.$apply();
    }));
